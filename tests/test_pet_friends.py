...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Димон", "Рыжый", "4", "images/kot.jpeg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Dimon', animal_type='cat', age=6):
...
def test_add_new_pet_with_valid_data_without_photo(name='Tar-tar', animal_type='sauce',
                                     age='15'):
...
def test_success_add_photo_of_pet(pet_photo='images/rom.jpeg'):
...
def test_add_new_pet_with_unvalid_auth_key_without_photo(name='kot', animal_type='pes',
                                     age='25'):
...
def test_add_new_pet_without_photo_with_unvalid_name(name='', animal_type='Tor',
                                     age='1'):
...
def test_add_new_pet_without_photo_with_unvalid_animal_type(name='Tor', animal_type='',
                                     age='1'):
...
def test_add_new_pet_without_photo_with_unvalid_age(name='Тоrt', animal_type='Kot',
                                     age='-7'):
...
def test_unsuccessful_add_new_pet(name='Ginger', animal_type='hen',
                                     age='1', pet_photo='images/kot.jpeg'):
...
def test_unsuccessful_add_photo_of_pet(pet_photo='images/rom.jpeg'):
...
def test_unsuccessful_delete_self_pet_():
    ...
    # Проверяем - если список своих питомцев пустой, то добавляем нового и опять запрашиваем список своих питомцев
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "ркот", "кот", "1", "images/kot.jpeg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
